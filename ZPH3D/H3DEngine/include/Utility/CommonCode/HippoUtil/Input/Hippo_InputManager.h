...
private:
	...
	int OnMouseLeftKeyDown(UINT uMsg, WPARAM wParam, LPARAM lParam );
	int OnMouseLeftKeyUp(UINT uMsg, WPARAM wParam, LPARAM lParam );

	int OnMouseRightKeyDown(UINT uMsg, WPARAM wParam, LPARAM lParam );
	int OnMouseRightKeyUp(UINT uMsg, WPARAM wParam, LPARAM lParam );

	int OnMouseMiddleKeyDown(UINT uMsg, WPARAM wParam, LPARAM lParam );
	int OnMouseMiddleKeyUp(UINT uMsg, WPARAM wParam, LPARAM lParam );
