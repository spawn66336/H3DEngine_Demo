...
namespace ZPH3D
{
	...
	public:
		...
		H3DI::IActor* CreateActor( const String& name , const bool male , const int mat_lod );

		H3DI::IModel* CreateDml( const String& path , const int mat_lod ); 

		H3DI::IAvatarSkeletonModel* CreatePet( const String& name , const bool male , const int mat_lod );
