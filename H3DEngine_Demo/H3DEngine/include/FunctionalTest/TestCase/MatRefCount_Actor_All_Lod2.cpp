...
class MatRefCountActorAllLod2 : public HippoTestCaseBase
{
public:
	MatRefCountActorAllLod2(const char* casename):HippoTestCaseBase(casename){}
...
ADD_TESTCASE("MATERIAL_TEST",MatRefCountActorAllLod2);