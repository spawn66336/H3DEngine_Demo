...
在测试用例中通过代码修改dml的材质实例内容，给这个材质实例的贴图换一张
	---注：加载4110003001下资源；替换贴图，法线贴图替换发现贴图
...
public:
	...
	{
		if (bCopy)
		{//这两个拷贝 可以保证每次使用的mat文件都是正确的
			CopyFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4110003001/back/4110003001.mat","../x52_test_resources/Reload测试用例资源/Reload贴图/4110003001/4110003001.mat",TRUE);
			CopyFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4110003001/back/__4110003001.mat","../x52_test_resources/Reload测试用例资源/Reload贴图/4110003001/__4110003001.mat",TRUE);
		}
		else
		{
			//每次程序退出前 清空使用的mat文件
			DeleteFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4110003001/4110003001.mat");
			DeleteFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4110003001/__4110003001.mat");
			DeleteFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4110003001/back.mat");
		}
	}
...
---注：加载4115001001下资源；替换贴图，用法线贴图替换固有色贴图
*/
...
public:
	...
	virtual void CopyOrDel(bool bCopy)
	{
		...
		{
			//这两个拷贝 可以保证每次使用的mat文件都是正确的
			CopyFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115001001/back/4115001001.mat","../x52_test_resources/Reload测试用例资源/Reload贴图/4115001001/4115001001.mat",TRUE);
			CopyFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115001001/back/__4115001001.mat","../x52_test_resources/Reload测试用例资源/Reload贴图/4115001001/__4115001001.mat",TRUE);
		}
		else
		{
			//每次程序退出前 清空使用的mat文件
			DeleteFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115001001/4115001001.mat");
			DeleteFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115001001/__4115001001.mat");
			DeleteFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115001001/back.mat");
		}
	}
...
---注：加载4115ddd下资源；替换贴图，用固有色贴图替换固有色贴图
*/
...
public:
	...
	virtual void CopyOrDel(bool bCopy)
	{
		...
		{
			//这两个拷贝 可以保证每次使用的mat文件都是正确的
			CopyFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115ddd/back/4115001001.mat","../x52_test_resources/Reload测试用例资源/Reload贴图/4115ddd/4115001001.mat",TRUE);
			CopyFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115ddd/back/__4115001001.mat","../x52_test_resources/Reload测试用例资源/Reload贴图/4115ddd/__4115001001.mat",TRUE);
		}
		else
		{
			//每次程序退出前 清空使用的mat文件
			DeleteFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115ddd/4115001001.mat");
			DeleteFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115ddd/__4115001001.mat");
			DeleteFile("../x52_test_resources/Reload测试用例资源/Reload贴图/4115ddd/back.mat");
		}
	}
...
/*测试逻辑
加载4110001001下dml 这里使用了 立方体贴图 
使用一个立方体贴图changed.dds 替换原有的立方体贴图hdr.dds
*/
...
public:
	...
	virtual void CopyOrDel(bool bCopy)
	{
		if (bCopy)
		{
			CopyFile(Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/back/hdr.dds").c_str(),
				Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/hdr.dds").c_str(),true);
			CopyFile(Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/back/changed.dds").c_str(),
				Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/changed.dds").c_str(),true);
		}
		else
		{
			DeleteFile(Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/hdr.dds").c_str());
			DeleteFile(Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/changed.dds").c_str());
			DeleteFile(Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/back.dds").c_str());
		}
	}
	virtual void  ChangeNameFirst()
	{
		rename(Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/hdr.dds").c_str(),
				Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/back.dds").c_str());
		rename(Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/changed.dds").c_str(),
			Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/hdr.dds").c_str());
	}
	virtual void Createdml()
	{
		CopyOrDel(true);
		m_pDml=m_pScene->CreateDml(Make_HippoTestResource_Path("Reload测试用例资源/Reload贴图/4110001001/4110001.dml").c_str(),GetMatLod());
	}
private: 
	static HippoTestCaseBase* const testcase_;
};
