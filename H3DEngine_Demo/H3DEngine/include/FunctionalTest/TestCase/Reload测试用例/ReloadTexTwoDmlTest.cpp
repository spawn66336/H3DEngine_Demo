...
/*测试逻辑
	逻辑同测试4，以lod0的方式进行--注：这里的资源带有mask材质 ，mask贴图 固有色贴图 高光贴图和法线贴图都相同
	实例中修改的是mask贴图，使用普通贴图进行替换
*/

class ReloadTextureTwoDml10 : public ReloadTextureTwoDml7
{
public:
	ReloadTextureTwoDml10(const char* casename):ReloadTextureTwoDml7(casename){}
...
ADD_TESTCASE("RELOAD_TESTCASE",ReloadTextureTwoDml10);

/*测试逻辑
	逻辑同测试4，以lod0的方式进行--注：这里的资源带有mask材质 ，mask贴图 固有色贴图 高光贴图和法线贴图都相同
	实例中修改的是固有色贴图，使用一个mask贴图替换
*/

class ReloadTextureTwoDml11 : public ReloadTextureTwoDml7
{
public:
	ReloadTextureTwoDml11(const char* casename):ReloadTextureTwoDml7(casename){}
...
ADD_TESTCASE("RELOAD_TESTCASE",ReloadTextureTwoDml11);

///*测试逻辑
//	逻辑同测试4，以lod0的方式进行--注：这里的资源带有mask材质 ，mask贴图 固有色贴图 高光贴图和法线贴图都相同
//	实例中修改的是固有色贴图，使用一个立方体贴图
//*/
//
//class ReloadTextureTwoDml12 : public ReloadTextureTwoDml7
//{
//public:
//	ReloadTextureTwoDml12(const char* casename):ReloadTextureTwoDml7(casename){}
//
//	virtual void ChangeDiskTex0First()
//	{
//		rename("../x52_test_resources/Reload测试用例资源/Reload贴图/有共同贴图的实例测试/有mask材质/4015012001/Texture/4015012001_D.dds",
//			"../x52_test_resources/Reload测试用例资源/Reload贴图/有共同贴图的实例测试/有mask材质/4015012001/Texture/back.dds");
//		rename("../x52_test_resources/Reload测试用例资源/Reload贴图/有共同贴图的实例测试/有mask材质/4015012001/Texture/waitingroom_d.tga",
//			"../x52_test_resources/Reload测试用例资源/Reload贴图/有共同贴图的实例测试/有mask材质/4015012001/Texture/4015012001_D.dds");
//	}
//	virtual void ChangeDiskTex0Second()
//	{
//		rename("../x52_test_resources/Reload测试用例资源/Reload贴图/有共同贴图的实例测试/有mask材质/4015012001/Texture/4015012001_D.dds",
//			"../x52_test_resources/Reload测试用例资源/Reload贴图/有共同贴图的实例测试/有mask材质/4015012001/Texture/waitingroom_d.tga");
//		rename("../x52_test_resources/Reload测试用例资源/Reload贴图/有共同贴图的实例测试/有mask材质/4015012001/Texture/back.dds",
//			"../x52_test_resources/Reload测试用例资源/Reload贴图/有共同贴图的实例测试/有mask材质/4015012001/Texture/4015012001_D.dds");
//	}
//
...
//	static HippoTestCaseBase* const testcase_;
//};
//ADD_TESTCASE("RELOAD_TESTCASE",ReloadTextureTwoDml12);